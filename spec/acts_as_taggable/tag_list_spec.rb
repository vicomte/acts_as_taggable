...
describe ActsAsTaggable::Extra::TagList do
  let(:tag_list) { ActsAsTaggable::Extra::TagList.new("awesome","radical") }

  it { should be_kind_of Array }

  it "#from should return empty array if empty array is passed" do
    ActsAsTaggable::Extra::TagList.from([]).should be_empty
  end
  ...
  describe "cleaning" do
    it "should parameterize if force_parameterize is set to true" do
      ...
      tag_list = ActsAsTaggable::Extra::TagList.new("awesome()","radical)(cc")

      tag_list.to_s.should == "awesome, radical-cc"
      ActsAsTaggable.force_parameterize = false
    end

    it "should lowercase if force_lowercase is set to true" do
      ActsAsTaggable.force_lowercase = true

      tag_list = ActsAsTaggable::Extra::TagList.new("aweSomE","RaDicaL")
      tag_list.to_s.should == "awesome, radical"

      ActsAsTaggable.force_lowercase = false
    end
