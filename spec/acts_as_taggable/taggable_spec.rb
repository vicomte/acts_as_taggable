...
describe "Taggable To Preserve Order" do
  ...
  it "should return tag list in the order the tags were created" do
    ...
    @taggable.instance_variable_get("@tag_list").instance_of?(ActsAsTaggable::Extra::TagList).should be_true
    
    lambda {
      @taggable.save
    }.should change(ActsAsTaggable::Tag, :count).by(3)
...
describe "Taggable" do
  ...
  it "should be able to create tags" do
    ...
    @taggable.instance_variable_get("@skill_list").instance_of?(ActsAsTaggable::Extra::TagList).should be_true
  ...
  it "should not care about case" do
    ...
    ActsAsTaggable::Tag.find(:all).size.should == 1
  ...
  describe "grouped_column_names_for method" do
    it "should return all column names joined for Tag GROUP clause" do
      @taggable.grouped_column_names_for(ActsAsTaggable::Tag).should == "tags.id, tags.name"
    end
